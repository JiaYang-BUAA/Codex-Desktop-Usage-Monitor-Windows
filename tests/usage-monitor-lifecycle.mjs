...
try {
  ...
  assert.deepEqual([...columns[1].querySelectorAll(".usage-column-brand > *")].map((item) => item.textContent), ["Codex Usage Monitor for Windows v3.1.1", "—— Designed by +羊 and Codex"]);
