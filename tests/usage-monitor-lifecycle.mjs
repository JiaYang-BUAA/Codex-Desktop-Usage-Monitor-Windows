...
try {
  ...
  assert.deepEqual([...columns[2].querySelectorAll(".usage-column-brand > *")].map((item) => item.textContent), ["Codex Usage Monitor for Windows v2.1.4", "—— Designed by +羊 and Codex"]);
