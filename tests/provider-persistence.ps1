...
try {
  ...
  Save-CodexUsageTokenBaseline -InitialTokens 500000000 -CheckpointAt 1784892000000 -RecentLogIds @('id:1', 'id:2') `
    -DailyDate '2026-07-24' -DailyTokens 125000 -DailyCheckpointAt 1784891900000 -DailyLogIds @('id:10', 'id:11')
  ...
  if ($baseline.schemaVersion -ne 5 -or -not $baseline.baselineConfigured -or $baseline.dailyDate -ne '2026-07-24' -or [long]$baseline.dailyTokens -ne 125000 -or [long]$baseline.dailyCheckpointAt -ne 1784891900000) { throw 'Daily Token state round-trip returned incorrect data.' }
