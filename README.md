...
面板左下方提供两个显示开关：开启“极简模式”后，折叠监视栏只显示数值与单位，不显示数据项名称，可最多选择 14 项，并在选中 9 项及以上时启用双行压缩布局；普通模式仍最多选择 8 项。开启“倒计时可视化”后，折叠监视栏最左侧显示与文字同色的圆形表盘，12 点方向有向外凸起的小块，绿色指针每 60 秒顺时针旋转一圈，刷新后重新从 12 点开始。这些选择保存在 Codex 本地页面设置中。
