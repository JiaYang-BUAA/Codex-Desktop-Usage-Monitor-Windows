...
**v2.0.1 更新：**对齐展开面板右下角的四个显示开关，并将“版本提醒”改为“版本更新提醒”；English UI 的 Token 数值改用常见的 `K`、`M`、`B` 缩写，中文界面继续使用“万”“亿”。
...
Token 显示规则：中文界面少于 `10,000` 时显示完整数值，达到 `10,000` 后以整数“万”显示，达到 `100,000,000` 后以两位小数“亿”显示；English UI 使用常见的 `K`、`M`、`B` 缩写。展开面板与折叠监视栏遵循相同单位规则。
